model_name_or_path=${1:-"/home/cr8dl-user/sameep/experiments/checkpoints_backup/llava-hound-tw"}
SAVE_DIR="/home/cr8dl-user/sameep/experiments"
output_dir=${2:-"$SAVE_DIR/llava_hound-tw-nextqa-sample"}
